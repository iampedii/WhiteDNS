...
object EnglishStrings : WhiteDnsStrings {
    ...
    override val profileFieldScanParallelism = "Initial Scan Resolvers"
    override val profileScanParallelismNote = "Resolvers probed at once during the first scan, before the tunnel connects. Higher is faster to connect. The engine drops the continuing background scan to one resolver by itself — but setting this to 1 serializes the first scan too. StormDNS profiles use the app-wide setting."
...
object PersianStrings : WhiteDnsStrings {
    ...
    override val profileFieldScanParallelism = "ریزالورهای اسکن اولیه"
    override val profileScanParallelismNote = "تعداد ریزالورهای همزمان در اسکن نخست، پیش از اتصال. مقدار بیشتر یعنی اتصال سریع‌تر. موتور اسکن پس‌زمینه را خودبه‌خود به یک ریزالور محدود می‌کند، اما مقدار ۱ اسکن نخست را هم کند می‌کند. پروفایل‌های StormDNS از تنظیم سراسری استفاده می‌کنند."
    override val profileFieldToml = "TOML"
